...
(function() {
    ...
    f = {
        ...
        hotTemplate: {
            container: '<div class="address_hot" style="display:none;top:0;-moz-box-shadow:1px 1px 11px #8A8A8A;-webkit-box-shadow:1px 1px 11px #8A8A8A;" id="address_hot">{$text}</div>',
        ...
        function S() {
            ...
            for (b in f.hotData) { // b:tab头标题
				...
				if(i!=0){
					...
					li_item += "<div style='margin-left:5px; color:#009688'>"+b+"</div>" + c;
					if(item_len%8 != 0){
        ...
        function L() {
            ...
            f.hotTarget = u;
                ...
                if (a) {
                    ...
                    p.style.backgroundColor = arr.length ? "#009688": "#0053AA";
                    if (!arr || !arr.length) {
...
(function() {
	var jsContainer = '<div id="tuna_alert" style="display:none;position:absolute;z-index:999;overflow:hidden;"></div><div id="tuna_jmpinfo" style="visibility:hidden;position:absolute;z-index:2147483647;"></div>';
