                    ...
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body ">
                            <table class="layui-table layui-form">
                                ...
                                <tbody>
                                    <?php if(is_array($orderlist)): $i = 0; $__LIST__ = $orderlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ordersItem): $mod = ($i % 2 );++$i;?><tr>
                                        <td>
                                            <input type="checkbox" name="" lay-skin="primary">
                                        </td>
                                        <td><?php echo ($ordersItem["ooid"]); ?></td>
                                        <td><?php echo ($ordersItem["go"]); ?></td>
										<td><?php echo ($ordersItem["arrive"]); ?></td>
										<td><?php echo ($ordersItem["date"]); ?></td>
                                        <td><?php echo ($ordersItem["ctime"]); ?></td>
										<td><?php echo ($ordersItem["amount"]); ?></td>
                                        <td><?php echo ($ordersItem["status"]); ?></td>
