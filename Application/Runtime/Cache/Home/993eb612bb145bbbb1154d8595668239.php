...
<html class="x-admin-sm">
    ...
    <body>
            ...
            <form>
                <select>
                    <?php if(is_array($contact)): $i = 0; $__LIST__ = $contact;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$contact1): $mod = ($i % 2 );++$i;?><option value=<?php echo ($contact1["cid"]); ?> ><?php echo ($contact1["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
                <button>wori</button>
            <form>
